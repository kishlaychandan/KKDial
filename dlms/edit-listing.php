...
$eid=$_GET['editid'];
$sql="update tbllisting set ListingTitle=:listingtitle,Keyword=:keywords,Category=:category,Website=:website,Address=:add,TemporaryAddress=:tadd,City=:city,State=:state,Country=:country,Zipcode=:zipcode,OwnerName=:ownername,Email=:email,Phone=:phone,CompanyWebsite=:comwebsite,OwnerDesignation=:ownerdesi,Company=:company,FacebookLink=:flink,TweeterLink=:twitterlink,Googlepluslink=:googlelink, Linkedinlink=:linkedin,Description=:description where ID=:eid";
...
<head>
    ...
    <!-- Page Title -->
    <title>KKDail|| Edit Listing</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="titile-block title-block_subpage">
                        <h2 style= " color:#6037ac;font-family: Times New Roman, Times, serif;font-size:50px;text-align:center;">Edit Listing</h2>
...
<img src="images/<?php echo $row->Logo;?>" width="200" height="200" value="<?php  echo $row->Logo;?>"><a href="changeimage.php?editid=<?php echo $row->ID;?>"> &nbsp; Edit Image</a>
                            ...
                            <!--//End Opening Hours -->
                            <script> CKEDITOR.replace('exampleFormControlTextarea1'); </script>
                        </form>
                    </div>
                </div>
            </div>
