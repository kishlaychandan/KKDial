            ...
            <div class="row">
                <div class="col-md-12 responsive-wrap">
                    ...
                    <div class="row detail-checkbox-wrap">
                       ...
                       <h3 class="card-title" style="padding-left: 20px;color:#6037ac;font-family: Times New Roman, Times, serif;font-size:50px; text-align:center;">Listing Detail</h3>
