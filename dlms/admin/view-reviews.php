...
<head>
  ...
  <title>KKDial | View Review Detail</title>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <table id="example1" class="table table-bordered table-striped">
                       <?php
$rid=intval($_GET['rid']);
$sql="select tblreview.ID,tblreview.ListingID,tblreview.Name,tblreview.Email,tblreview.Status,tblreview.Subject,tblreview.Message,tblreview.DateofReview,tbllisting.ListingTitle,tbllisting.Company,tbllisting.CompanyWebsite,tbllisting.CompanyWebsite,tbllisting.Email, tbllisting.Phone,tbllisting.OwnerName from tblreview join tbllisting on tbllisting.ID=tblreview.ListingID
