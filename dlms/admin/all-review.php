...
<head>
  ...
  <title>KKDial | All Reviews</title>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <?php
$sql="select tblreview.ID,tblreview.ListingID,tblreview.Name,tblreview.Email,tblreview.Subject,tblreview.Message,tblreview.DateofReview,tbllisting.ListingTitle from tblreview join tbllisting on tbllisting.ID=tblreview.ListingID";
