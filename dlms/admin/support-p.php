...
$mobnum=$_POST['mobnum'];
$email=$_POST['email'];
$sql="update tblpage set PageTitle=:pagetitle,PageDescription=:pagedes,Email=:email,MobileNumber=:mobnum where  PageType='support'";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
             ...
             <form action="#" method="post" enctype="multipart/form-data">
              <?php
              $sql="SELECT * from  tblpage where PageType='support'";
              $query = $dbh -> prepare($sql);
              $query->execute();
