...
<head>
  ...
  <title>Directory Listing Management System | Forgot Password</title>
...
<body class="hold-transition login-page" style= " background-color:#6037ac;">
<div class="login-box" style= " background-color:#FF8C00;">
  <div class="login-logo">
    <a href="login.php"><b>Admin</b>|| DLMS</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body" style= " background-color:#FF8C00;">
