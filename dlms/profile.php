            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="titile-block title-block_subpage">
                        <h2 style= " color:#6037ac;font-family: Times New Roman, Times, serif;font-size:50px;text-align:center;">Profile</h2>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <div class="payment-title">
                                                ...
                                                <h4 style= "font-family: Gill Sans, Times, serif;font-size:30px;text-align:center;">Profile Information</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
