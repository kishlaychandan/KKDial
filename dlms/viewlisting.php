...
$categories = $_GET['lid']; // Get the selected category from the URL parameter
            ...
            <div class="row">
                <div class="col-md-12 responsive-wrap">
                    ...
                    <div class="row detail-checkbox-wrap">
                       ...
                       <h3 class="card-title" style="padding-center: 20px;">Search Detail</h3>
                       <hr />
                      
                    </div>
                    <div class="row record">
                        <?php
                            $sql = "SELECT * FROM tbllisting WHERE tbllisting.Category = :category"; // Updated query with a condition for selected category
                            $query = $dbh->prepare($sql);
                            $query->bindParam(':category', $categories, PDO::PARAM_STR); // Bind the selected category value to the query
                            $query->execute();
                        ...
                        ?>
                            <p style="color:red;font-size:40px;font-family: Times New Roman;text-align: center;">No Record Found</p>
<?php }?>
                    </div>
                </div>
